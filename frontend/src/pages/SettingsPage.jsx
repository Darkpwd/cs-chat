...
const PREVIEW_MESSAGES = [
  ...
  {
    id: 2,
    content: "Estou ótimo! Só trabalhando em algumas novas funcionalidades.",
    isSent: true,
  },
];
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">
            Escolha um tema para sua interface de chat
          </p>
        </div>
        ...
        <h3 className="mb-3 text-lg font-semibold">Pré-visualização</h3>
              ...
              <div className="overflow-hidden shadow-sm bg-base-100 rounded-xl">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-medium">Lamartine suicída</h3>
                ...
                <div className="p-4 border-t border-base-300 bg-base-100">
                  <div className="flex gap-2">
                    <input
                      ...
                      value="Esta é uma pré-visualização"
                      readOnly
                    />
